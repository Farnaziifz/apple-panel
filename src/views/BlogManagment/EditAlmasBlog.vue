  ...
  methods: {
    async getBlogData() {
      ...
      if (response.responseCode === 200) {
        ...
        this.oldBlogCat = response.data.article_category.name;
        this.MainUrl = response.data.image_url.url;
        this.thumUrl = response.data.image_url.thumb_url;
        this.selectedStatus = response.data.status;
        this.selectedCategory = response.data.article_category_id
        if (response.data.status === 1) {
          this.oldBlogSts = "فعال";
        } else {
          this.oldBlogSts = "غیرفعال";
        }
